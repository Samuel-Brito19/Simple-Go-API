...
var books = []book{
	{ID: "1", Title: "War and Peace", Author: "Leo Tolstoy", Quantity: 3},
	{ID: "2", Title: "Red book", Author: "Mao Zedong", Quantity: 3},
	{ID: "3", Title: "Moby Dick", Author: "Herman Melville", Quantity: 2},
}
